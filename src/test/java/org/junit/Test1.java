...
//propio de la vista
		...
		String sonoffbody="<div class=\"card-body\">"
				...
				+ "<form role=\"form\" action=\"/home/settimerString/CAMBIARSONOFF\" method=\"get\" enctype=\"multipart/form-data\"><input type=\"hidden\" name=\"sonoffTimerString\" value=\"one\"/><button type=\"submit\" class=\"btn btn-primary btn-sm btn-block\">Cambiar Funcion de Encendido/Apagado automatico</button></form>"
				+ "</div>";
		...
		sonoffbody="<div class=\"card-body\">"
				...
				+ "<form role=\"form\" action=\"/home/settimerString/CAMBIARSONOFF\" method=\"get\" enctype=\"multipart/form-data\"><input type=\"hidden\" name=\"sonoffTimerString\" value=\"two\"/> <button type=\"submit\" class=\"btn btn-primary btn-sm btn-block\">Cambiar Funcion de Encendido/Apagado automatico</button></form>"
