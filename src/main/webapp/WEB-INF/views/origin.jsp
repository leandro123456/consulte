  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Devices <sup>1</sup></div>
      </a>
	...
	<div class="card shadow mb-4">
		...
		<p></p>
           <div class="card border-left-primary shadow h-50 py-2">
             <div class="card-body">
               <div class="row no-gutters align-items-center">
                 <div class="col mr-2">
                   <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Humedad</div>
                 </div>
                 <div class="col-auto" id="chartHum">
                   <i class="fas fa-calendar fa-2x text-gray-300"></i>
                 </div>
               </div>
             </div>
		...
		<div class="row">
                <div class="col-lg-6 mb-4" id="chartTempC">
...
<!--                   </div> -->
                ...
                <div class="col-lg-6 mb-4" id="chartHiC">
...
<!--                   </div> -->
                ...
                <div class="col-lg-6 mb-4" id="chartTempF">
...
<!--                   </div> -->
                ...
                <div class="col-lg-6 mb-4" id="chartHiF">
