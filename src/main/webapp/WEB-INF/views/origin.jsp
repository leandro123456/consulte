		               ...
		               <div class="row no-gutters align-items-center">
		                 <div class="col-12">
		                   <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Temperatura</div>
							...
							<div class="col-6" id="chartTempC"></div>
			                <div class="col-6" id="chartHiC"></div>
			                <div class="col-6" id="chartTempF"></div>
			                <div class="col-6" id="chartHiF"></div>
		                 </div>
		             </div>
		           </div>
		     </div>
