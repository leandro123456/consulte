        ...
        <form role="form" action="<c:url value="home/create"/>" method="post">
        	<div class="modal-body">
					...
					<div id="infoFinalSoft" style="display:none">
						<h5>La configuraci�n est� lista. Precione Agregar Dispositivo para terminar.</h5>
						<p></p>
					</div>
					<div class="btn-group">
        ...
        <form role="form" action="<c:url value="home/create"/>" method="post">
        	<div class="modal-body">
        		...
        		<div id="infoGeneral" style="display:inline">
					...
					<p></p>
					<b>Descripci�n</b> 
					<input name="descriptiondevice" id="descriptiondevice" class="form-control" placeholder="Mi descripci�n">
					<p></p>
				</div>
				...
				<div id="infoAvanzada" style="display:none">
					<h3>Configuraci�n avanzada</h3>
						<div id="parametersConexion" onkeypress=checkPassword()>
							<h6>Los siguientes son los par�metros con los que su equipo ha sido configurado de f�brica. No los modifique si no est� seguro de lo que est� haciendo.</h6>
							<div class="form-group row ">
								...
								<b>Contrase�a MQTT</b>
									...
									id="passescuchar" placeholder="Contrase�a"> 
								<b>Repetir contrase�a MQTT</b> 
									<input type="password"
							...
							<h6>Administraci�n Remota</h6>
							<div class="form-group row ">
								<b>URL del Broker MQTT de Administraci�n Remota</b> 
									<input type="text"
									class="form-control form-control-user"
									id="iphostescucharremote" placeholder="Hostname o direccion IP"> 
								<b>Puerto del Broker MQTT de Administraci�n Remota</b>
									<input type="text" class="form-control form-control-user"
									id="portescucharremote" placeholder="Puerto"> 
								<b>Nombre de usuario MQTT de Administraci�n Remota</b> 
									<input
									type="text" class="form-control form-control-user"
									id="userescucharremote" placeholder="Nombre de usuario"> 
								<b>Contrase�a MQTT de Administraci�n Remota</b>
									<input type="password" class="form-control form-control-user"
									id="passescucharremote" placeholder="Contrase�a"> 
								<b>Confirmar contrase�a MQTT de Administraci�n Remota</b> 
									<input type="password"
									class="form-control form-control-user"
									id="confirpassescucharremote" placeholder="Confirmar Contrase�a">
								<b>Topico de resultados de Administraci�n Remota</b>
									<input type="text"
									class="form-control form-control-user " id="topiclistenremote"
									placeholder="Topico para recepcion de Respuestas"> 
								<b>Topico de comandos de Administraci�n Remota</b>
									<input type="text"
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">�Est� listo para finalizar su sesi�n actual?</div>
        <div class="modal-footer">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">�Esta seguro de confirmar la acci�n?</div>
        <div class="modal-footer">
