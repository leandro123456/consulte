...
<head>
	<title>cDash - Ayuda sobre dispositivos</title>
					...
					<section class="wrapper">
						<div class="inner">
							<header class="align-center">
								<h1>Tu dispositivos</h1>
								<p>Aprende c&oacutemo agregar dispositivos en tu panel de control, configurarlos, compartirlos y eliminarlos.</p>
							</header>
							<div class="flex flex-2">
									...
									<p><img class="image fit" src="resources/loginresources/css/images/ayuda/devices01.jpg" /></p>
									<p>Selecciona el tipo de dispositivo que deseas agregar.</p>
									<p><img class="image fit" src="resources/loginresources/css/images/ayuda/devices02.jpg" /></p>
									<p>Luego, completa los datos y selecciona <b>"Continuar"</b>. Puedes completar libremente los campos "Nombre del dispositivo" y "Descripci&oacuten", ya que utilizar&aacutes esta informaci&oacuten para diferenciar este dispositivo de otros en el panel de control. <b>Es muy importante que ingreses correctamente el numero de serie del dispositivo</b> para poder identificarlo y que funcione correctamente. Por ejemplo, para un dispositivo Bridge Coiaca BRDCS01 para paneles de alarma DCS, el numero de serie es del tipo DSC010000000xxx</p>
									<p><img class="image fit" src="resources/loginresources/css/images/ayuda/devices04.jpg" /></p>
									<p>Al ingresar los datos del dispositivo de forma correcta se incluir&aacute en el panel de control el wiget correspondiente y si el equipo se encuentra encendido y configurado, comenzar&aacutes a ver la iformaci&oacuten en pantalla y, dependiendo del modelo del dispositivo, tambi&eacuten podr&aacutes controlarlo.</p>
										
									
									<p>- Consulta las <a href="/Hfaq"><b>preguntas frecuentes</b></a> para más informaci&oacuten</p>
