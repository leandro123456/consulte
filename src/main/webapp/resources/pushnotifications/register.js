...
const registerUrl = 'http://localhost:80/register';
const serviceWorkerUrl = 'http://localhost:80/resources/pushnotifications/serviceWorker.js';
const publicVapidKey = 'BHmZ6n2uQAlvxCNToc2iA9bbHNAVK3gEkbzEtCbPCh5SVOtuTFhFnvubLu5Z6-Uqi77nh7OE0JbCV4lVZNBsJZ8';
